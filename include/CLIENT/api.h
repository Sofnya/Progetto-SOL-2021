...
/**
 * Crea un nuovo file, e lo apre, è equivalente a un open_file con flags |= O_CREATE, ma permette la gestione dei capacity miss.
 * Se dirname != null eventuali file espulsi per far posto al nuovo file verranno scritti in 'dirname'.
